...
public:
	...
	//static bool getCloudAndNormals(const std::string &_inputFile, pcl::PointCloud<pcl::PointNormal>::Ptr &_cloud, const double _estimationRadius = -1);	//Allen_20221003A_¤ä´©BPAÂI¶³ÂàSTL
