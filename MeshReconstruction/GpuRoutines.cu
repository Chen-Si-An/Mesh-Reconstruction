...
//	 checkErrors("cudaMemcpyFromSymbol failed");
	...
	//checkErrors("cudaFree devNeighbors failed");	//Allen_20221006A_Ball Pivoting使用GPU加速
...
//Allen_20221006A_Ball Pivoting使用GPU加速
{
	...
	*/
	...
	delete hostMem;	//Allen_20221006A_Ball Pivoting使用GPU加速
...
void GpuRoutines::prepareStackSize()
{
	...
	//checkErrors("cudaDeviceSetLimit failed");	//Allen_20221006A_Ball Pivoting使用GPU加速
}
