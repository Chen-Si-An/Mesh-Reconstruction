...
public:
	...
	static size_t getAvailableMemory()
	{
		...
		//checkErrors("memInfo failed");	//Allen_20221006A_Ball Pivoting使用GPU加速
		return freeMem;
	}
	...
	static inline void allocMemory(T **_devDst, const int _size)
	{
		...
		//checkErrors("cudaMalloc failed");	//Allen_20221006A_Ball Pivoting使用GPU加速
	}
	...
	static inline void createInDev(T **_devDst, const T *_hostSrc, const int _size)
	{
		...
		//checkErrors("cudaMemcpy failed");	//Allen_20221006A_Ball Pivoting使用GPU加速
	}
	...
	static inline void setSymbol(T &_devSymbol, const T *_hostSrc)
	{
		...
		//checkErrors("cudaMemcpyToSymbol failed");	//Allen_20221006A_Ball Pivoting使用GPU加速
	}
